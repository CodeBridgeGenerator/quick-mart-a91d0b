...
import SingleAdminPage from "../components/app_components/AdminPage/SingleAdminPage";
import AdminProjectLayoutPage from "../components/app_components/AdminPage/AdminProjectLayoutPage";
import SingleSupplierPage from "../components/app_components/SupplierPage/SingleSupplierPage";
import SupplierProjectLayoutPage from "../components/app_components/SupplierPage/SupplierProjectLayoutPage";
import SingleItemPage from "../components/app_components/ItemPage/SingleItemPage";
import ItemProjectLayoutPage from "../components/app_components/ItemPage/ItemProjectLayoutPage";
...
import SingleAddressPage from "../components/app_components/AddressPage/SingleAddressPage";
import AddressProjectLayoutPage from "../components/app_components/AddressPage/AddressProjectLayoutPage";
import SingleSupermarketPage from "../components/app_components/SupermarketPage/SingleSupermarketPage";
import SupermarketProjectLayoutPage from "../components/app_components/SupermarketPage/SupermarketProjectLayoutPage";
import SingleOrderItemPage from "../components/app_components/OrderItemPage/SingleOrderItemPage";
import OrderItemProjectLayoutPage from "../components/app_components/OrderItemPage/OrderItemProjectLayoutPage";
...
import SingleCouponPage from "../components/app_components/CouponPage/SingleCouponPage";
import CouponProjectLayoutPage from "../components/app_components/CouponPage/CouponProjectLayoutPage";
import SingleTaxPage from "../components/app_components/TaxPage/SingleTaxPage";
import TaxProjectLayoutPage from "../components/app_components/TaxPage/TaxProjectLayoutPage";
import SingleSupportTicketPage from "../components/app_components/SupportTicketPage/SingleSupportTicketPage";
import SupportTicketProjectLayoutPage from "../components/app_components/SupportTicketPage/SupportTicketProjectLayoutPage";
//  ~cb-add-import~
...
<Route path="/admin/:singleAdminId" exact element={<SingleAdminPage />} />
<Route path="/admin" exact element={<AdminProjectLayoutPage />} />
<Route path="/supplier/:singleSupplierId" exact element={<SingleSupplierPage />} />
<Route path="/supplier" exact element={<SupplierProjectLayoutPage />} />
<Route path="/item/:singleItemId" exact element={<SingleItemPage />} />
<Route path="/item" exact element={<ItemProjectLayoutPage />} />
<Route path="/order/:singleOrderId" exact element={<SingleOrderPage />} />
<Route path="/order" exact element={<OrderProjectLayoutPage />} />
<Route path="/address/:singleAddressId" exact element={<SingleAddressPage />} />
<Route path="/address" exact element={<AddressProjectLayoutPage />} />
<Route path="/supermarket/:singleSupermarketId" exact element={<SingleSupermarketPage />} />
<Route path="/supermarket" exact element={<SupermarketProjectLayoutPage />} />
<Route path="/orderItem/:singleOrderItemId" exact element={<SingleOrderItemPage />} />
<Route path="/orderItem" exact element={<OrderItemProjectLayoutPage />} />
...
<Route path="/coupon/:singleCouponId" exact element={<SingleCouponPage />} />
<Route path="/coupon" exact element={<CouponProjectLayoutPage />} />
<Route path="/tax/:singleTaxId" exact element={<SingleTaxPage />} />
<Route path="/tax" exact element={<TaxProjectLayoutPage />} />
<Route path="/supportTicket/:singleSupportTicketId" exact element={<SingleSupportTicketPage />} />
<Route path="/supportTicket" exact element={<SupportTicketProjectLayoutPage />} />
