...
import seederData from "./supportTicket.seeder.json";
...
const SupportTicketSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SupportTicketSeederDialogComponent);
