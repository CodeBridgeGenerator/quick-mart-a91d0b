...
import seederData from "./coupon.seeder.json";
...
const CouponSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CouponSeederDialogComponent);
